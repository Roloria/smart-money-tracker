...
function getStockPrice(ticker: string): number {
  const priceMap: Record<string, number> = {
    ...
    '2319.HK': 10, '600519.SS': 2200, '600036.SS': 50,
    '601318.SS': 70, '600030.SS': 70, '000333.SS': 70,
    '600276.SS': 80, '002415.SS': 60, '601012.SS': 40,
    '600887.SS': 50, BAC: 40, BLK: 1050,
  };
  return priceMap[ticker] || priceMap[ticker.replace('.', '_')] || 100;
}

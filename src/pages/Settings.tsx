  ...
  return (
    <div>
      ...
      <div style={{maxWidth:640}}>
        ...
        {/* About */}
        <div className="card-base" style={{padding:24,marginBottom:20}}>
          <div style={{fontSize:14,fontWeight:600,color:'#fafafa',marginBottom:12}}>Smart Money Tracker v61 ⚡</div>
          <div style={{display:'grid',gridTemplateColumns:'1fr 1fr',gap:10,fontSize:12,color:'#71717a'}}>
            <div><span style={{color:'#52525b'}}>当前版本：</span><span style={{fontFamily:'JetBrains Mono,monospace',color:'#a1a1aa'}}>v61 ⚡</span></div>
          ...
          <div style={{marginTop:10,fontSize:12,color:'#3f3f46',lineHeight:1.6}}>v61 ⚡：Search副标题优化 + AlertRules版本同步 + Settings About v60→v61（2026-05-02）。</div>
        </div>
